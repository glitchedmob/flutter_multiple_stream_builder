...
void main() {
  ...
  testWidgets('StreamBuilder7 rebuilds with stream updates', (tester) async {
    await tester.pumpWidget(
      StreamBuilder7<int, int, int, int, int, int, int>(
  ...
  testWidgets('StreamBuilder7 handles initialData', (tester) async {
    await tester.pumpWidget(
      StreamBuilder7<int, int, int, int, int, int, int>(
        streams: StreamTuple7(
          streamController1.stream,
        ...
        initialData: InitialDataTuple7(1, 2, 3, 4, 5, 6, 7),
        builder: (context, snapshots) {
          snapshot1Values.add(snapshots.snapshot1.data);
          snapshot2Values.add(snapshots.snapshot2.data);
          snapshot3Values.add(snapshots.snapshot3.data);
