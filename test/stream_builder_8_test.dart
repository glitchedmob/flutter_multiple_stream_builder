...
void main() {
  ...
  testWidgets('StreamBuilder8 rebuilds with stream updates', (tester) async {
    await tester.pumpWidget(
      StreamBuilder8<int, int, int, int, int, int, int, int>(
  ...
  testWidgets('StreamBuilder8 handles initialData', (tester) async {
    await tester.pumpWidget(
      StreamBuilder8<int, int, int, int, int, int, int, int>(
        streams: StreamTuple8(
          streamController1.stream,
        ...
        initialData: InitialDataTuple8(1, 2, 3, 4, 5, 6, 7, 8),
        builder: (context, snapshots) {
          snapshot1Values.add(snapshots.snapshot1.data);
          snapshot2Values.add(snapshots.snapshot2.data);
          snapshot3Values.add(snapshots.snapshot3.data);
